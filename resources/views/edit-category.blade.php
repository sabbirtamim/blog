                    ...
                    <div class="box-body container">
                        ...
                        <div class="register-box-body  col-md-8 col-md-offset-2">
                            <form action="/category/update/{{ $data->id }}" method="post">
                                ...
                                <div class="form-group has-feedback">
                                    <input type="text"  class="form-control" placeholder="Category type slug" name="slug" value="{{$data->slug}}"/>
                                    @if ($errors->has('slug'))
                                        <span class="help-block">
                                ...
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control" placeholder="Category type description" name="term_description" value="{{$data->term_description}}"/>
