        ...
        <div class="register-box">
            ...
            <div class="register-box-body">
                ...
                <form action="{{ url('/register') }}" method="post">
                    ...
                    @endif
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="phone number" name="phone number" value="{{ old('phone_number') }}"/>
                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    </div>
                    <div class="form-group has-feedback">
                        <select   placeholder="{{ trans('adminlte_lang::message.gender') }}" name="gender" value="{{ old('gender') }}" class="form-control">
